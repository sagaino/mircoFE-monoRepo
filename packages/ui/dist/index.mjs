      ...
      header: /* @__PURE__ */ jsxs(
        Header,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx2(Box, { sx: { flexGrow: 1 } }),
            user && /* @__PURE__ */ jsxs(Box, { sx: { display: "flex" }, children: [
              ...
              /* @__PURE__ */ jsx2(Button2, { variant: "light", onClick: () => setUser(null), children: "Logout" })
            ] }),
            !user && /* @__PURE__ */ jsx2(Button2, { variant: "light", onClick: () => setUser("Sagaino"), children: "Login" })
          ]
        }
      ),
      children
